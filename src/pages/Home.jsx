...
const Home = () => {
  ...
  return (
    ...
    <div className="md:p-8 p-0 ">
          ...
          >
            <div className="flex flex-col gap-4 w-[40%]">
              <div className="flex flex-col md:gap-4 gap-2 ">
                ...
                <div className="text-white md:text-5xl text-2xl md:mb-8 mb-4 ">
            ...
            <div className="w-[60%]">
              <img src={Banner} className="lg:h-[290px] h-[200px] w-[400px]" />
            </div>
          </div>{" "}
      ...
      <div className="md:h-[50vh] h-[80vh] w-[95%] md:w-[100%]  rounded-lg border-[1px] border-gray-200 flex flex-col justify-between">
      ...
      <div className="md:h-[100vh] h-[210vh] rounded-lg border-[1px] border-gray-300  my-8 ">
        <div className="flex justify-between p-8">
...
<div className="flex text-white items-center ">
  <div className="text-xl"><FaTruckFast /></div>
  <div>Free shipping over $100</div>
</div>
<div className="flex text-white items-center">
  <div className="text-xl"><GiBackwardTime /></div>
  <div>30 DAYS MONEY BACK </div>
  </div>
<div className="flex text-white items-center">
  <div className="text-xl">< RiSecurePaymentFill /></div>
  <div>100% SECURE PAYMENT</div>
  </div>
<div className="flex text-white items-center">
  <div className="text-xl"><GiVanillaFlower /></div>
  <div>FREE PRODUCT RETURN</div>
  </div>
<div className="flex text-white items-center">
  <div className="text-xl"><IoHeadsetSharp /></div>
  <div>24/7 ONLINE & OFFLINE SUPPORT</div>
      ...
      <div className="md:h-[100vh] h-[270vh] flex  md:flex-row flex-col mt-8  ">
        <div className="bg-[#362526] md:h-[79.4vh] h-[82vh] rounded-l-lg  md:w-[25%] w-[100%]">
          <div className="h-[50%]">
            <div className="text-2xl text-white flex items-center justify-center">Flash Sale</div>
          ...
          <div className="flex justify-center items-center"><img src={dog} className=" w-[150px] flex justify-center items-center md:mt-20 mt-56  "/></div>
        </div></div>
        <div className="h-full md:w-[75%] w-[100%] rounded-r-lg border-[1px] border-gray-400">
        <div className=" h-[79.4%] w-[100%] rounded-r-lg border-b-[1px] border-gray-400">
        ...
        <div className="h-[20.6%] w-[100%] flex flex-col md:flex-row justify-between p-8">
          <div className="flex flex-col justify-center items-center">
            <div className="text-[#362526] text-xl font-bold">Newsletter</div>
            <div className="text-[#422f30] text-x">40% offer on the way</div>
          </div>
          <div className="flex justify-center items-center h-[35px] border-[1px] border-black rounded-full pl-2 gap-2">
            <div><IoMdMail /></div>
            <input placeholder="Enter Your Email Address"/>
          <button className="rounded-full bg-[#362526] text-white w-[100px] h-full">Subscribe</button></div>
        </div>
        </div>
      </div>
      <div className="md:h-[100vh] h-[270vh] flex flex-col md:flex-row mt-8  ">
        <div className="bg-[#f6ab4a] h-[79.4vh] md:h-[78vh] rounded-l-lg  md:w-[25%] w-[100%]">
          <div className="h-[50%]">
            <div className="text-2xl text-white flex items-center justify-center">Flash Sale</div>
            <div className="text-white flex flex-col justify-between h-[100%] p-8 gap-6">
          ...
          <div className="flex justify-center items-end"><img src={cat} className=" w-[150px] mt-48 md:mt-14 flex items-end"/></div>
        </div></div>
        <div className="h-full md:w-[75%]  w-[100%] rounded-r-lg border-[1px] border-gray-400">
        <div className=" h-[78%] w-[100%] rounded-r-lg border-b-[1px] border-gray-400">
          <div className="relative   flex flex-row lg:justify-start justify-center">
          <div className="flex gap-2 mt-16 flex-col md:flex-row text-sm">
            {product.map((Product, index) => (
              <Productcard
