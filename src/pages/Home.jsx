...
<div className='h-[100vh] rounded-lg border-[1px] border-gray-300  my-8'>
  ...
  <div className="relative  px-4 mx-4 flex flex-row lg:justify-start justify-center">
        <div className='flex gap-8 md:gap-2 mt-16 flex-col md:flex-row px-8'>
